...
#include "XstoreProcessTable.h"

#include <stdlib.h>
#include <string.h>

#include "ProcessTable.h"
#include "XstoreProcess.h"


ProcessTable* ProcessTable_new(Machine* host, Hashtable* pidMatchList) {
   XstoreProcessTable* this = xCalloc(1, sizeof(XstoreProcessTable));
...
void ProcessTable_delete(Object* cast) {
   XstoreProcessTable* this = (XstoreProcessTable*) cast;
...
void ProcessTable_goThroughEntries(ProcessTable* super) {
   ...
   proc = ProcessTable_getProcess(super, 1, &preExisting, XstoreProcess_new);
   ...
   Process_updateCmdline(proc, "<xstore architecture>", 0, 0);
