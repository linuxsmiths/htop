...
#include "xstore/XstoreProcess.h"
...
Process* XstoreProcess_new(const Machine* host) {
   Process* this = xCalloc(1, sizeof(XstoreProcess));
   Object_setClass(this, Class(XstoreProcess));
...
static void XstoreProcess_rowWriteField(const Row* super, RichString* str, ProcessField field) {
   const XstoreProcess* up = (const XstoreProcess*) super;
...
static int XstoreProcess_compareByKey(const Process* v1, const Process* v2, ProcessField key) {
   const XstoreProcess* p1 = (const XstoreProcess*)v1;
   const XstoreProcess* p2 = (const XstoreProcess*)v2;
...
const ProcessClass XstoreProcess_class = {
   .super = {
      .super = {
      ...
      .writeField = XstoreProcess_rowWriteField
   },
   .compareByKey = XstoreProcess_compareByKey
};
